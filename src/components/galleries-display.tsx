...
import { getImages, 
 ...
 } from "@/lib/actions/galleries-action"
...
// interface GalleriesDisplayClientProps {
//   galleries: Product[]
// }

export default async function GalleriesDisplay(
  // { galleries }: GalleriesDisplayClientProps
) {
            ...
            {galleries.map((gallery) => (
              ...
              >
                    ...
                    <Dialog>
                      ...
                      <DialogContent className="max-w-3xl">
                        <DialogHeader>
                          ...
                          <DialogTitle>{gallery.price} $</DialogTitle>
                        </DialogHeader>
                ...
                <div className="p-4">
                  ...
                  <p className="font-semibold truncate mb-1 text-sm">{gallery.price} $</p>
